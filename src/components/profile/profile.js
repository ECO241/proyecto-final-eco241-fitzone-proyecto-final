document.addEventListener('DOMContentLoaded', function() {
    ...
    gearIcon.innerHTML = '<img src="/src/img/varios/gear.png" alt="gear icon">';
    ...
    profileImage.src = '/src/img/varios/perfil.png'; // replace with your image path
    ...
    stats.forEach(stat => {
        ...
        statIcon.innerHTML = `<img src="/src/img/varios/${stat.icon}" alt="${stat.label} icon">`; // replace with your icon path
